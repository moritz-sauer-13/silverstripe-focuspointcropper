(function($) {
    ...
    console.log('CROPPER');
    jQuery(document).on('click ajaxStop', function (event) {
      console.log('CROPPER '+event.type);
      console.log($('#Form_fileEditForm_FocusPoint_Holder .focuspoint-field').length ? "CROPPER PRESENT!" : "(notfound)");
    });

        $('#Form_fileEditForm_FocusPoint_Holder .focuspoint-field').entwine({
